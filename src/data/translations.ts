...
export const translations: Record<string, Translation> = {
  sv: {
    ...
    tools: {
      ...
      'uuid-generator': { name: 'UUID-generator', description: 'Skapa slumpmässiga UUID:er (v4) direkt i webbläsaren', hint: 'Kopiera en eller alla på en gång.' },
      'epoch-omvandlare': { name: 'Epoch-omvandlare', description: 'Omvandla mellan Unix-tidsstämpel och datum/tid, åt båda hållen', hint: 'Stödjer både sekunder och millisekunder.' },
      'bas-omvandlare': { name: 'Bas-omvandlare', description: 'Omvandla heltal mellan binärt, oktalt, decimalt och hexadecimalt', hint: 'Skriv i valfritt fält så uppdateras de andra direkt.' },
  ...
  en: {
    ...
    tools: {
      ...
      'uuid-generator': { name: 'UUID Generator', description: 'Generate random v4 UUIDs right in your browser', hint: 'Copy one or all at once.' },
      'epoch-omvandlare': { name: 'Epoch Converter', description: 'Convert between Unix timestamps and human dates, both ways', hint: 'Supports both seconds and milliseconds.' },
      'bas-omvandlare': { name: 'Base Converter', description: 'Convert integers between binary, octal, decimal and hexadecimal', hint: 'Type in any field and the others update live.' },
  ...
  es: {
    ...
    tools: {
      ...
      'uuid-generator': { name: 'Generador de UUID', description: 'Genera UUID v4 aleatorios directamente en tu navegador', hint: 'Copia uno o todos a la vez.' },
      'epoch-omvandlare': { name: 'Conversor de epoch', description: 'Convierte entre marcas de tiempo Unix y fechas legibles, en ambos sentidos', hint: 'Admite segundos y milisegundos.' },
      'bas-omvandlare': { name: 'Conversor de bases', description: 'Convierte enteros entre binario, octal, decimal y hexadecimal', hint: 'Escribe en cualquier campo y los demás se actualizan al instante.' },
  ...
  fr: {
    ...
    tools: {
      ...
      'uuid-generator': { name: 'Générateur d\'UUID', description: 'Générez des UUID v4 aléatoires directement dans votre navigateur', hint: 'Copiez-en un ou tous à la fois.' },
      'epoch-omvandlare': { name: 'Convertisseur epoch', description: 'Convertissez entre horodatage Unix et dates lisibles, dans les deux sens', hint: 'Prend en charge les secondes et les millisecondes.' },
      'bas-omvandlare': { name: 'Convertisseur de bases', description: 'Convertissez des entiers entre binaire, octal, décimal et hexadécimal', hint: 'Saisissez dans un champ et les autres se mettent à jour en direct.' },
  ...
  de: {
    ...
    tools: {
      ...
      'uuid-generator': { name: 'UUID-Generator', description: 'Erzeuge zufällige v4-UUIDs direkt im Browser', hint: 'Kopiere eine oder alle auf einmal.' },
      'epoch-omvandlare': { name: 'Epoch-Umrechner', description: 'Rechne zwischen Unix-Zeitstempel und lesbarem Datum um, in beide Richtungen', hint: 'Unterstützt Sekunden und Millisekunden.' },
      'bas-omvandlare': { name: 'Basis-Umrechner', description: 'Rechne ganze Zahlen zwischen binär, oktal, dezimal und hexadezimal um', hint: 'Tippe in ein beliebiges Feld und die anderen aktualisieren sich sofort.' },
  ...
  pt: {
    ...
    tools: {
      ...
      'uuid-generator': { name: 'Gerador de UUID', description: 'Gere UUID v4 aleatórios diretamente no navegador', hint: 'Copie um ou todos de uma vez.' },
      'epoch-omvandlare': { name: 'Conversor de epoch', description: 'Converta entre marcas de tempo Unix e datas legíveis, nos dois sentidos', hint: 'Suporta segundos e milissegundos.' },
      'bas-omvandlare': { name: 'Conversor de bases', description: 'Converta inteiros entre binário, octal, decimal e hexadecimal', hint: 'Escreva em qualquer campo e os outros atualizam-se ao instante.' },
