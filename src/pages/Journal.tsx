...
const typeBadgeClass: Record<string, string> = {
  ...
  changed: 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300 hc:bg-white hc:text-black',
...
export default function Journal() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <Link
        to="/"
        className="mb-6 inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 hc:text-white transition-colors hover:text-gray-900 dark:hover:text-white"
      >
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-gray-600 dark:text-gray-300 hc:text-gray-200">{t.journal.description}</p>
      </div>
      ...
      <Link
        to="/"
        className="mt-8 inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 hc:text-white transition-colors hover:text-gray-900 dark:hover:text-white"
      >
        <ArrowLeft className="h-4 w-4" />
        {t.backToTools}
      </Link>
