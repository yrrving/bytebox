    ...
    <div className="mx-auto max-w-2xl space-y-6 py-10">
      ...
      {loading && (
        <div className="flex items-center justify-center py-12">
          <RefreshCw className="h-6 w-6 animate-spin text-gray-600 dark:text-gray-300" />
        </div>
      )}
      ...
      {data && !loading && (
        <>
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 hc:border-white bg-gray-50 dark:bg-gray-800 hc:bg-black p-6 text-center">
            <p className="text-xs text-gray-600 dark:text-gray-300 mb-1">{ip?.yourIp ?? 'Din IP-adress'}</p>
