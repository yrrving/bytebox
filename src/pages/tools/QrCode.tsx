    ...
    <div className="mx-auto max-w-3xl space-y-6 py-10">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 hc:border-white bg-gray-50 dark:bg-gray-800 hc:bg-black p-4">
        <div className="flex flex-wrap items-end gap-4">
          <div>
            <label className="mb-1 block text-xs text-gray-600 dark:text-gray-300">{q?.size ?? 'Storlek'}</label>
            <select
              value={size}
          ...
          <div>
            <label className="mb-1 block text-xs text-gray-600 dark:text-gray-300">{q?.foreground ?? 'Förgrund'}</label>
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-mono text-xs text-gray-600 dark:text-gray-300">{fgColor}</span>
            </div>
          </div>
          <div>
            <label className="mb-1 block text-xs text-gray-600 dark:text-gray-300">{q?.background ?? 'Bakgrund'}</label>
            <div className="flex items-center gap-2">
              <input
                type="color"
                value={bgColor}
                ...
                className="h-9 w-9 cursor-pointer rounded border border-gray-300 dark:border-gray-600 hc:border-white"
              />
              <span className="font-mono text-xs text-gray-600 dark:text-gray-300">{bgColor}</span>
            </div>
          </div>
        </div>
      </div>
